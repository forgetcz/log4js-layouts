 ...
 *
 * @param {IJsonLayoutConfig} currentConfig
 ...
 * @param {IJsonLayoutConfig} commonJsonOutput Common data fot all messages
...
export function hangoutFormatter(
    ...
    let message = commonJsonOutput.content?.message?.length
