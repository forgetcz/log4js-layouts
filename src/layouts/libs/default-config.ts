...
import { IDateTimeFormat, IJsonLayoutConfig } from '../../../types/types';
...
/** @description Default configuration for error formatting */
export const defaultJsonLayoutErrorFormat: Options = {
...
export const defaultJsonLayoutConfig: IJsonLayoutConfig = {
